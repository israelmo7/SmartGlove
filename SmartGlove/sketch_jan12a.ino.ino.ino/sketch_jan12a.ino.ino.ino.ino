...
char ssid[] = "G4";          //  your network SSID (name) 
char pass[] = "10203040";   // your network password

int status = WL_IDLE_STATUS;
IPAddress server(192,168,43,164);  // serverIP
 ...
 */
  ...
  itoa(floorUp(event.acceleration.x), buffX, 10);
 // Serial.print(buffX);
 // Serial.print("  (X)  ");
  fillPlace(buffX,3);
 // Serial.print(buffX);
 // Serial.println();
  itoa(floorUp(event.acceleration.y), buffY, 10);
 // Serial.print(buffY);
 // Serial.print("  (Y)  ");
  fillPlace(buffY,3);
  //Serial.print(buffY);
 // Serial.println();
  ...
  itoa(floorUp(event.acceleration.z), buffZ, 10);
  //Serial.print(buffZ);
 // Serial.print("  (Z)  ");
  fillPlace(buffZ,3);
  //Serial.print(buffZ);
